...
export default function PricesPage() {
  ...
  const categoryStats = prices.reduce((acc, p) => {
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
            <CardContent className="p-4">
              ...
              <p className="text-2xl font-bold text-green-800">
                ₱{prices.length > 0 && prices[0]?.price_prevailing ? Math.min(...prices.map(p => p.price_prevailing || Infinity)).toFixed(2) : '0'}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-red-50 border-orange-200">
            <CardContent className="p-4">
              ...
              <p className="text-2xl font-bold text-orange-800">
                ₱{prices.length > 0 && prices[0]?.price_prevailing ? Math.max(...prices.map(p => p.price_prevailing || 0)).toFixed(2) : '0'}
              </p>
            </CardContent>
          </Card>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-amber-100 border-b border-amber-200">
                        ...
                        <th className="text-left p-4 font-semibold text-amber-900">Specification</th>
                        <th className="text-right p-4 font-semibold text-amber-900">Price (₱/kg)</th>
                      </tr>
                    </thead>
                    <tbody>
          ...
          <Card className="border-amber-300 bg-gradient-to-br from-amber-50 to-orange-50">
            <CardContent className="text-center p-12">
              ...
              <p className="text-amber-900 font-bold text-xl mb-2">
                Wala pang presyo ngayon.
              </p>
              <p className="text-amber-700 text-lg mb-1">
                Check back mamaya! 🛒
              </p>
              <p className="text-sm text-amber-600 mt-4">
                Babalik kami ng bagong presyo sa susunod na update.
              </p>
            </CardContent>
          </Card>
        )}
